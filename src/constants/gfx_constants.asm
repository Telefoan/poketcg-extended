...
; icon tile offsets
DEF ICON_TILE_BASIC_POKEMON EQU $CC
DEF ICON_TILE_STAGE_1_POKEMON EQU $D0
DEF ICON_TILE_STAGE_2_POKEMON EQU $D4
DEF ICON_TILE_TRAINER EQU $D8

DEF ICON_TILE_FIRE EQU $DC
DEF ICON_TILE_GRASS EQU $E0
DEF ICON_TILE_LIGHTNING EQU $E4
DEF ICON_TILE_WATER EQU $E8
DEF ICON_TILE_FIGHTING EQU $EC
DEF ICON_TILE_PSYCHIC EQU $F0
DEF ICON_TILE_COLORLESS EQU $F4
DEF ICON_TILE_ENERGY EQU $F8
