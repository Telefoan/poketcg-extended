...
BoosterTypes:
	...
	db BOOSTER_COLOSSEUM  ; BOOSTER_COLOSSEUM_JUST_TRAINER
	db BOOSTER_LABORATORY ; BOOSTER_LABORATORY_JUST_TRAINER
	db BOOSTER_MYSTERY    ; BOOSTER_MYSTERY_JUST_TRAINER
	db BOOSTER_EVOLUTION  ; BOOSTER_EVOLUTION_JUST_TRAINER
